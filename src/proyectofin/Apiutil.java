...
public class Apiutil extends Product {
    ...
    public String BusquedaporID(String productId) {
        String apiUrl = "https://api.escuelajs.co/api/v1/products/" + productId;
        return makeHttpRequest(apiUrl);
    }

    public List<String> Busquedaportitulo(String partialTitle) {
    ...
    public void anilizadordedata(String jsonData) {
