    ...
    public String buscar() {
        ...
        switch (opcion2) {
            case 1:
                ...
                String productData = producto.BusquedaporID(productId);
            ...
            case 2:
                ...
                List<String> eleciondeProducts = producto.Busquedaportitulo(partialTitle);

                if (!eleciondeProducts.isEmpty()) {
                    System.out.println("Producto encontrado o similares:");
                    for (int i = 0; i < eleciondeProducts.size(); i++) {
                        producto.anilizadordedata(eleciondeProducts.get(i));
                    ...
                    if (seleccion > 0 && seleccion <= eleciondeProducts.size()) {
                        producto.anilizadordedata(eleciondeProducts.get(seleccion - 1));
                        producto.detallesdeproducto();
                    } else {
